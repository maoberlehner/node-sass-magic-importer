...
ava_1.default(`Should be an object.`, (t) => {
    const onceImporter = new OnceImporter_1.OnceImporter(t.context.dependencies, t.context.options);
...
ava_1.default(`Should resolve the absolute URL.`, (t) => {
    ...
    const onceImporter = new OnceImporter_1.OnceImporter(dependencies, t.context.options);
