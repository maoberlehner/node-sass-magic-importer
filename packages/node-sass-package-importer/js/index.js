...
// @TODO: do not return scss, return @import statements (multiple if multiplefiles are found in the main in the bower_json)
...
export class PackageImporter {
  ...
  importer(
    ...
    return function nodeSassImporter(url, prev, done) {
      ...
      PackageImporter.resolve(url, includePaths).then((data) => {
        done(data);
      });
    };
  }
